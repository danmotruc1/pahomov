    ...
    if (menu) {
        ...
        return (
            ...
            >
                                ...
                                <div className="d-lg-flex justify-content-lg-end align-items-lg-center">
                                    ...
                                    <div className="d-flex justify-lg-content-end align-items-center meta-icons">
                                        <div className="media">
                                            <div className="media-body">
                                                <h6>
                                                    <img src="/static/media/mail.0467e2ba.png" />
                                                    Mail Us
                                                </h6>
                                                <p className="fw-400">pahomov@gmail.com</p>
                                            </div>
                                        </div>
                                        <div className="media">
                                            <div className="media-body">
                                                <h6>
                                                    <img src="/static/media/phone.0f2a0098.png" />
                                                    Phone
                                                </h6>
                                                <p className="fw-400">+49123777777777</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div
                    className="page_header_wrapper ds ms affix-top-wrapper"
                    style={{ height: 50 }}
                >
                    <header className="page_header s-py-10 s-py-lg-0 ds ms s-overlay nav-bordered justify-nav-center affix-top">
                        <div className="container-fluid">
                            <div className="row align-items-center">
                                <div className="d-lg-none col-11">
                                    <a href="/" className="logo">
                                ...
                                <div className="col-xl-12">
                                    <div className="nav-wrap">
                                        <nav className="top-nav">
                                            <ul
                                                className="nav sf-menu sf-js-enabled sf-arrows"
                                                style={{ touchAction: "pan-y" }}
                                                id="maniu"
                                            >
                                                <li className={`menuuu ${location === '/' ? 'active' : ''}`}>
                                                    <a className="menuuu" href="/">Home</a>
                                                </li>

                                                <li className={`menuuu ${location.includes('/team') ? 'active' : ''}`}>
                                                    <a className="menuuu" href="/team">Team</a>
                                                </li>
                                                {/* <li className={location.includes('/blog') ? 'active' : ''}>
                                                 <a href="/blog">Blog</a>
                                             </li> */}
                                                <li className={`menuuu ${location === '/gallery' ? 'active' : ''}`}>
                                                    <a className="menuuu" href="/gallery">Gallery</a>
                                                </li>
                                                <li className={`menuuu ${location === '/services' ? 'active' : ''}`}>
                                                    <a className="menuuu" href="/services">Services</a>
                                                </li>
                                                <li className={`menuuu ${location === '/about-us' ? 'active' : ''}`}>
                                                    <a className="menuuu" href="about-us">About Us</a>
                                                </li>
                                                <li className={`menuuu ${location === '/faq' ? 'active' : ''}`}>
                                                    <a className="menuuu" href="/faq">FAQ</a>
                                                </li>
                                                <li className={`menuuu ${location === '/contact' ? 'active' : ''}`}>
                                                    <a className="menuuu" href="/contact">Contact</a>
                                                </li>
                                            </ul>
                                        </nav>
                                    </div>
